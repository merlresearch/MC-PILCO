...
"""
File to load from the logs the final policy obtained with MC-PILCO4 and test it in the simualted cart-pole system
"""
...
for i in range(num_test):
    state_samples, input_samples, noiseless_samples = PL_obj.system.rollout(
        s0=initial_state,
